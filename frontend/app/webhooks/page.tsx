...
const events = [
  {
    ...
    payload: '{ "event": "document.processed", "document_id": "doc_abc123", "status": "ready" }',
  ...
  },
  {
    ...
    payload: '{ "event": "compliance.alert", "jurisdiction": "RRA", "severity": "high" }',
    color: "text-rose-500",
    bg: "bg-rose-500/10",
  },
  {
    ...
    payload: '{ "event": "deadline.reminder", "deadline": "2025-03-31", "days_remaining": 7 }',
  ...
  },
  {
    ...
    payload: '{ "event": "training.completed", "model_id": "mdl_xyz789", "accuracy": 0.94 }',
